...
| Foundry (forge) | ERROR running --version | ✅ |
| Foundry (anvil) | ERROR running --version | ✅ |
| Foundry (cast) | ERROR running --version | ✅ |
...
| Foundry (forge/anvil/cast) | ❌ Failed (glibc 2.31) |
...
See E2E test results below for `feistel17_permutation`, `feistel17_inverse_roundtrip`,
and `feistel17_multi_seed`. A real Go-native Poseidon2-based Feistel17 is used
(NOT the Python SHA256 approximation from v1).
...
| ✅ | `feistel17_inverse_roundtrip` | passed | 0 | ⚠️ expected 131072 unique, got 0
| ✅ | `feistel17_multi_seed` | passed | 0 |
| ❌ | `foundry_forge` | failed | 1 |
| ❌ | `foundry_anvil` | failed | 1 |
| ❌ | `foundry_cast` | failed | 1 |
...
4. **Cross-Test Vectors**: 0 test cases for Poseidon2 permutation verification.
